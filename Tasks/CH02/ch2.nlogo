...
to setup-erics
  create-erics max-start-turtles [
...
to setup-particles
  ...
  create-particles 2 [
    ...
    set shape "circle"
    set color black
    set size (random (max_size - min_size) + min_size)
  ]
end
...
to solve-turtle-collision [other-turtle]
  forward -1 * size
  right 180
